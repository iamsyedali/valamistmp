valamisReportSettings.module('Views.SelectUsers', function (SelectUsers, valamisReportSettings, Backbone, Marionette, $, _) {
  ...
  SelectUsers.EditUsersToolbarView = valamisApp.Views.BaseLayout.ToolbarView.extend({
    template: '#reportSettingsUsersToolbarViewTemplate',
  ...
  SelectUsers.EditUsersListItemView = valamisApp.Views.BaseLayout.ListItemView.extend({
    template: '#reportSettingsEditUsersItemViewTemplate',
    initialize: function() {
      this.events = _.extend({}, this.constructor.__super__.events, this.events);
    },
    deleteItem: function() {
  ...
  SelectUsers.UsersView = valamisApp.Views.BaseLayout.MainLayoutView.extend({
    ...
    initialize: function(options) {
      ...
      this.collection = new valamisReportSettings.Entities.UsersCollection();
