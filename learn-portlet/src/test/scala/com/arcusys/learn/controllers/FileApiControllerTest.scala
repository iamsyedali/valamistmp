...
//  //      FileRequest.ContentType, UploadContentType.Package.toString,
//  //      PackageRequest.CourseId, Mocks.FileFacade.courseId.toString,
//  //      PackageRequest.ScormUserId, Mocks.FileFacade.userId.toString,
//  //      PackageRequest.LiferayGroupId, Mocks.FileFacade.groupId.toString)
//  //
//  //    Mocks.FileFacade.doFileContentStub()
